...
// certificates
import L_ReactToDoList from "../../assets/img/certificates/React_ToDo_List.webp";
import L_MernTipCalc from "../../assets/img/certificates/mern_tip_calc.webp";
import L_GetGitHubInfo from "../../assets/img/certificates/get_github_info.webp";
import L_SmartBrain from "../../assets/img/certificates/brain.webp";
import L_RoboFriends from "../../assets/img/certificates/Robofriends.webp";
import L_ProductHuntClone from "../../assets/img/certificates/product_hunt_clone.webp";
import L_PortfolioUsingDjango from "../../assets/img/certificates/portfolioUsingDjango.webp";
...
const TimeLine = () => {
	return (
		<div>
			<h1 className="pt-3 text-center font-details-b pb-3">Certificates</h1>
			<Timeline>
				<Events>
